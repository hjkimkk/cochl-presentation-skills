...
| Research findings / paper summary | Research — fast paper readout, findings-first | [`decks/research-findings-summary-template.md`](decks/research-findings-summary-template.md) — ~9-slide concise summary (light body + dark section slides, editorial rule-line cards); short sibling of the full research-paper deck | ✅ |
